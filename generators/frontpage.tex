...
\HRule \\[0.5cm]
\begin{Huge}
	\bfseries{Formalizing a problem in dependent type theory and extracting a certified program from the proof of its specification}\\[0.7cm] % Title of your document
\end{Huge}
\HRule \\[0.5cm]
...
\large \emph{Author:} Andreas Salhus Bakseter\\
\large \emph{Supervisors:} Marc Bezem, Håkon Robbestad Gylterud\\[2cm]
