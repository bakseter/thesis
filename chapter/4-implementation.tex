...
As seen in \autoref{sec:case}, we want to represent clauses as
...
Given any set of clauses and a function assigning values to the variables (frontier),
...
\textcolor{red}{explain this, cite extraction papers maybe}
