...
The function \lstinline{vars_set_atom} use below simply returns all the variables
...
The inductive case of \lstinline{m} by far the largest part of the proof (see lines 17-199 of \Cref{lst:thm_32_full_proof}).
