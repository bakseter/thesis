...
As discussed in \autoref{ch:the_case_in_question}, we want to represent clauses as
...
We also want to model functions of the form $f : V \rightarrow \mathbb{N}^{\infty}$.
...
As briefly mentioned in \autoref{ssec:propositions_as_types}, a proof can often be used to compute something.
...
Lemma 3.3 from \cite{mbezem} is used in the proof of Theorem 3.2 to solve \textcolor{red}{fill inn explanation here...}
