...
The error that occured in the example of a universe inconsistency in \Cref{lst:universe_inconsistency}
...
\subsection{Extension of \Cref{lst:thm_32_coq_example} that fails}

Due to not having given a formal proof of \Cref{lem:3.3},
...
This false claim is a consequence of not having given a formal proof of \Cref{lem:3.3}.

\textcolor{red}{explain, refer to Theorem 3.2 overview from chapter 4}
