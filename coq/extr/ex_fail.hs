...
cs :: ([]) Clause0
cs =
  (:) (Clause ((:) (Atom "a" 0) ([])) (Atom "c" (Prelude.succ (Prelude.succ
    0)))) ((:) (Clause ((:) (Atom "c" (Prelude.succ (Prelude.succ 0))) ([]))
    (Atom "d" (Prelude.succ (Prelude.succ (Prelude.succ 0))))) ([]))
