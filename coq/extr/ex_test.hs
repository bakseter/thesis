...
sub_forward cs0 v w f =
  let {x = sub_vars_improvable cs0 v w f} in
  let {
   f' = \v0 ->
    case set_mem
           ((Prelude.==) :: Prelude.String -> Prelude.String -> Prelude.Bool)
...
thm_32 :: Prelude.Integer -> Prelude.Integer -> (Set Clause0) -> (Set
          ...
          -> Ex_lfp_geq
thm_32 n m cs0 v w f x =
  nat_rect (\_ cs1 v0 _ f0 _ _ _ _ ->
    eq_rec_r ([]) (ex_lfp_geq_empty cs1 f0)
      (nodup
        ((Prelude.==) :: Prelude.String -> Prelude.String -> Prelude.Bool)
        v0)) (\n0 iHn m0 ->
    nat_rect (\cs1 v0 w0 f0 _ _ _ h2 ->
      ex_lfp_geq_incl cs1
        (nodup
          ((Prelude.==) :: Prelude.String -> Prelude.String -> Prelude.Bool)
          v0)
        (nodup
          ((Prelude.==) :: Prelude.String -> Prelude.String -> Prelude.Bool)
          w0) f0 h2) (\m1 iHm cs1 v0 w0 f0 _ _ _ h2 ->
      let {
       h3 = le_lt_eq_dec
              (length
                (set_diff
      ...
      in
      case h3 of {
       Prelude.True -> iHm cs1 v0 w0 f0 __ __ __ h2;
       Prelude.False ->
        let {h5 = iHn n0 cs1 w0 ([]) f0 __ __ __ f0} in
        let {
         h = lem_33 cs1 v0
               (nodup
                 ((Prelude.==) :: Prelude.String -> Prelude.String -> Prelude.Bool)
...
type Fail_ex_0' = Pre_thm

def :: Ex_lfp_geq
def =
  ex_lfp_geq_empty cs fail_ex_0_f

fail_ex_0_errthang :: Ex_lfp_geq
fail_ex_0_errthang =
  fail_ex_0 def
